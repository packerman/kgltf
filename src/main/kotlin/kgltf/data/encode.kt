...
object DataUri {
    ...
    fun encode(uri: URI): ByteArray {
        val matchResult = dataUriRegex.matchEntire(uri.schemeSpecificPart)
                ?: throw IllegalArgumentException("Uri '${uri.toString().substring(0, 30)}...' doesn't match data scheme")
